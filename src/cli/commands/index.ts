...
export function showBanner(): void {
  ...
  console.log(`    ${chalk.yellow("run method <name>")}           Run an installed method`);
  console.log(
  ...
  console.log(`    ${chalk.yellow("runner setup <name>")}         Initialize a runner`);
  console.log(`    ${chalk.yellow("runner set-default <name>")}   Set the default runner`);
  console.log(`    ${chalk.yellow("runner status")}                Show runner configuration`);
  console.log(`    ${chalk.yellow("telemetry enable|disable")}    Toggle anonymous telemetry\n`);

  console.log(chalk.bold("  Installation:"));
  console.log(`    ${chalk.yellow("install <address>")}         Install a method package\n`);

  console.log(chalk.bold("  Package Management:"));
  console.log(`    ${chalk.yellow("package init")}               Initialize METHODS.toml`);
  console.log(`    ${chalk.yellow("package list")}               Display the package manifest`);
  console.log(`    ${chalk.yellow("package validate")}           Validate METHODS.toml\n`);

  console.log(chalk.dim("  Learn more: https://github.com/mthds-ai/mthds-js/blob/main/CLI.md\n"));
}
