...
// Source: tests/fixtures/protocol/input_form.json (provenance in the README beside it).
// The `InputForm` annotation is the compile-time parity check between that payload
...
export const INPUT_FORM_FIXTURE: InputForm = {
    ...
    fields: [
      {
        ...
        fields: [
          ...
          },
          {
            ...
            required: false,
            default_value: "PROBE_default_motto",
          },
          {
            kind: "number",
            name: "count",
          ...
          },
          {
            ...
            required: false,
            default_value: "2026-01-15T12:30:00",
            datetime: true,
          },
          {
            kind: "text",
            ...
            item: {
              ...
              fields: [
                ...
                },
                {
                  kind: "object",
                  name: "trinket",
                  concept_ref: "input_semantics_probe.Trinket",
          ...
          },
          {
            ...
            required: false,
            default_value: "PROBE_choice_casual",
            choices: ["PROBE_choice_formal", "PROBE_choice_casual", "PROBE_choice_playful"],
          },
          {
            kind: "enum",
            name: "only_choice",
          ...
          },
          {
            ...
            required: false,
            choices: ["PROBE_choice_typed_a", "PROBE_choice_typed_b"],
          },
          {
            kind: "number",
            name: "constrained_count",
            description:
  ...
  "input_semantics_probe.probe_refined": {
    fields: [
      ...
      },
      {
        ...
        refines: ["input_semantics_probe.BaseEntity"],
      ...
      },
      {
        ...
        refines: ["input_semantics_probe.SpecialEntity", "input_semantics_probe.BaseEntity"],
