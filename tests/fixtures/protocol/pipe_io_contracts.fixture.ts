...
// Source: tests/fixtures/protocol/pipe_io_contracts.json (provenance in the README beside it).
// The `PipeIOContracts` annotation is the compile-time parity check between that payload
// and the type; the runtime test asserts this value deep-equals the JSON.

import type { PipeIOContracts } from "../../../src/protocol/pipe_io_contracts.js";

export const PIPE_IO_CONTRACTS_FIXTURE: PipeIOContracts = {
  "input_semantics_hinted.hinted_slots": {
    inputs: {
      plain: {
        ...
        json_schema: {
          description:
            "HINTED_concept_Essay: description-only concept carrying a concept-level hint",
          properties: {
            text: {
          ...
          required: ["text"],
          title: "input_semantics_hinted.Essay",
          type: "object",
        },
      },
      expanded_plain: {
      ...
      hinted: {
        concept_ref: "input_semantics_hinted.Review",
        presence: "plain",
        multiplicity: "single",
        item_count: null,
        json_schema: {
          description: "HINTED_concept_Review: structured concept with field-level hints",
          properties: {
            headline: {
              anyOf: [
                {
              ...
              default: null,
              description: "HINTED_field_headline: text field hinted as a label",
              title: "Headline",
            },
            body: {
              description: "HINTED_field_body: text field hinted as prose",
              title: "Body",
              type: "string",
            },
            stars: {
              ...
              default: null,
              description: "HINTED_field_stars: integer field hinted as a rating",
              title: "Stars",
            },
            plain: {
              anyOf: [
              ...
              default: null,
              description: "HINTED_field_plain: hint-free field beside hinted ones",
              title: "Plain",
            },
            quirk: {
              anyOf: [
              ...
              default: null,
              description:
                "HINTED_field_quirk: field carrying an unknown hint key (content-lenient, preserved)",
              title: "Quirk",
            },
          },
          required: ["body"],
          title: "input_semantics_hinted.Review",
          type: "object",
        },
      },
      hinted_marked: {
        ...
        json_schema: {
          ...
          items: {
            ...
            required: ["text"],
            title: "input_semantics_hinted.Badge",
            type: "object",
          },
        },
      },
      ...
      widget: {
        ...
        json_schema: {
            ...
            input_semantics_probe__Gadget: {
              ...
              properties: {
                ...
                trinket: {
                  anyOf: [
                    {
                      $ref: "#/$defs/input_semantics_probe__Trinket",
                    },
                    {
                      type: "null",
                    },
                  ...
                  default: null,
                  description: "PROBE_desc_field_gadget_trinket: nested concept, level two",
                },
              },
              required: ["name"],
              title: "input_semantics_probe__Gadget",
              type: "object",
            },
            input_semantics_probe__Trinket: {
              description: "PROBE_desc_concept_Trinket: leaf structure for two-level nesting",
              properties: {
                label: {
                  description:
                    "PROBE_desc_field_trinket_label: shorthand string field on the nesting leaf",
                  title: "Label",
                  type: "string",
                },
              },
              required: ["label"],
              title: "input_semantics_probe__Trinket",
              type: "object",
            },
          },
          ...
          properties: {
            shorthand_note: {
              description:
                "PROBE_desc_field_shorthand_note: shorthand string field (implies text, required)",
              title: "Shorthand Note",
              type: "string",
            },
            title: {
              description: "PROBE_desc_field_title: required text",
              title: "Title",
              type: "string",
            },
            subtitle: {
              ...
              default: null,
              description: "PROBE_desc_field_subtitle: optional text (required omitted)",
              title: "Subtitle",
            },
            summary: {
              anyOf: [
              ...
              default: null,
              description: "PROBE_desc_field_summary: optional text (required explicit false)",
              title: "Summary",
            },
            motto: {
              anyOf: [
              ...
              default: "PROBE_default_motto",
              description: "PROBE_desc_field_motto: text with default",
              title: "Motto",
            },
            count: {
              anyOf: [
              ...
              default: 42,
              description: "PROBE_desc_field_count: integer with default",
              title: "Count",
            },
            enabled: {
              anyOf: [
              ...
              default: true,
              description: "PROBE_desc_field_enabled: boolean with default",
              title: "Enabled",
            },
            price: {
              anyOf: [
              ...
              default: 9.99,
              description: "PROBE_desc_field_price: number with default",
              title: "Price",
            },
            released_on: {
              anyOf: [
              ...
              default: "2026-01-15",
              description: "PROBE_desc_field_released_on: date with default",
              title: "Released On",
            },
            launched_at: {
              anyOf: [
              ...
              default: "2026-01-15T12:30:00",
              description: "PROBE_desc_field_launched_at: datetime with default",
              title: "Launched At",
            },
            daily_at: {
              anyOf: [
              ...
              default: "12:30:00",
              description: "PROBE_desc_field_daily_at: time with default",
              title: "Daily At",
            },
            tags: {
              anyOf: [
              ...
              default: ["PROBE_tag_a", "PROBE_tag_b"],
              description: "PROBE_desc_field_tags: list of text with default",
              title: "Tags",
            },
            ratings: {
              anyOf: [
              ...
              default: null,
              description: "PROBE_desc_field_ratings: list of integer",
              title: "Ratings",
            },
            matrix: {
              anyOf: [
              ...
              default: null,
              description: "PROBE_desc_field_matrix: nested list with unspecified inner item",
              title: "Matrix",
            },
            gadgets: {
              anyOf: [
                {
                  items: {
                    $ref: "#/$defs/input_semantics_probe__Gadget",
                  },
                  type: "array",
                },
                {
              ...
              default: null,
              description: "PROBE_desc_field_gadgets: list of concept",
              title: "Gadgets",
            },
            attributes: {
              anyOf: [
              ...
              default: null,
              description: "PROBE_desc_field_attributes: dict text to text",
              title: "Attributes",
            },
            scores: {
              anyOf: [
              ...
              description: "PROBE_desc_field_scores: dict text to number with default",
              title: "Scores",
            },
            milestones: {
              anyOf: [
              ...
              default: null,
              description: "PROBE_desc_field_milestones: dict text to date",
              title: "Milestones",
            },
            main_gadget: {
              $ref: "#/$defs/input_semantics_probe__Gadget",
              description: "PROBE_desc_field_main_gadget: required concept field",
            },
            icon: {
              anyOf: [
                {
              ...
              default: null,
              description: "PROBE_desc_field_icon: native concept field",
            },
            tone: {
              anyOf: [
                {
                  enum: ["PROBE_choice_formal", "PROBE_choice_casual", "PROBE_choice_playful"],
                  type: "string",
                },
                {
                  type: "null",
              ...
              default: "PROBE_choice_casual",
              description: "PROBE_desc_field_tone: choices with default",
              title: "Tone",
            },
            only_choice: {
              anyOf: [
                {
                  const: "PROBE_choice_single",
                  type: "string",
                },
                {
                  type: "null",
            ...
            typed_choice: {
              anyOf: [
                {
                  enum: ["PROBE_choice_typed_a", "PROBE_choice_typed_b"],
                  type: "string",
                },
                {
                  type: "null",
            ...
            constrained_count: {
              ...
              default: null,
              description:
                "PROBE_desc_field_constrained_count: integer carrying unknown constraint keys",
              title: "Constrained Count",
            },
          },
          required: ["shorthand_note", "title", "main_gadget"],
          title: "input_semantics_probe.Widget",
          type: "object",
        },
      },
      gadget_q: {
        ...
        json_schema: {
          ...
          required: ["name"],
          title: "input_semantics_probe.Gadget",
          type: "object",
        },
      },
      note: {
        ...
        json_schema: {
          ...
          required: ["text"],
          title: "input_semantics_probe.PlainNote",
          type: "object",
        },
      },
    },
  ...
  "input_semantics_probe.probe_refined": {
    inputs: {
      refdoc: {
        concept_ref: "input_semantics_probe.RefinedDoc",
        presence: "plain",
        multiplicity: "single",
        item_count: null,
        json_schema: {
          ...
          required: ["url"],
          title: "input_semantics_probe.RefinedDoc",
          type: "object",
        },
      },
      special: {
        concept_ref: "input_semantics_probe.SpecialEntity",
        presence: "plain",
        multiplicity: "single",
        item_count: null,
        json_schema: {
          ...
          properties: {
            ident: {
              description: "PROBE_desc_field_base_ident: inherited field",
              title: "Ident",
              type: "string",
            },
          },
          required: ["ident"],
          title: "input_semantics_probe.SpecialEntity",
          type: "object",
        },
      },
      extra: {
        concept_ref: "input_semantics_probe.ExtraSpecialEntity",
        presence: "plain",
        multiplicity: "single",
        item_count: null,
        json_schema: {
          ...
          required: ["ident"],
          title: "input_semantics_probe.ExtraSpecialEntity",
          type: "object",
        },
      },
      classbacked: {
        concept_ref: "input_semantics_probe.ClassBacked",
        presence: "plain",
        multiplicity: "single",
        item_count: null,
        json_schema: {
          description:
            "PROBE_desc_concept_ClassBacked: structure declared as an existing class name",
          properties: {
            text: {
              description: "The text",
              title: "Text",
          ...
          required: ["text"],
          title: "input_semantics_probe.ClassBacked",
          type: "object",
        },
      },
      stringnote: {
        ...
        json_schema: {
          ...
          required: ["text"],
          title: "input_semantics_probe.StringNote",
          type: "object",
        },
      },
    },
